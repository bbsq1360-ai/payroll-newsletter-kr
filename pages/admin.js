          ...
          {!authed ? (
            ...
            <div>
              <div style={styles.notice}>
                💡 수치를 수정하고 저장하면 다음 뉴스레터 생성부터 즉시 반영됩니다.
              </div>
                  ...
                  <div style={styles.fieldRow}>
                    ...
                    <div style={styles.fieldItem}>
                      ...
                      <input
                        ...
                        placeholder="예: ↑ +2.9% · 월 2,156,880원"
                      />
                    </div>
                  </div>
                </div>
              ...
              <div style={styles.saveRow}>
                ...
                {saved && <p style={styles.successText}>✅ 저장되었습니다!</p>}
                <button
                  onClick={save}
                  disabled={saving}
...
const styles = {
  ...
  loginCard: {
    ...
    maxWidth: 420, margin: "2rem auto", textAlign: "center"
  },
  ...
  notice: {
    ...
    color: "#185FA5", marginBottom: 20
  },
  fieldCard: {
    background: "#fff", borderRadius: 12,
    border: "1px solid #e8e8e8", padding: "1.25rem",
    marginBottom: 12
  },
